                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="header-top-info header-login-info">
                        <ul class="info-list">
                            ...
                            <li><a href="sign-up.html"><i class="fa fa-sign-in-alt"></i> Sign up</a></li>
                            <li>
                                <a href="#">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  $btc = $_POST['btc'];
      ...
      if(!empty($fname) && !empty($lname) && !empty($uname) && !empty($email)&& !empty($password) && !empty($btc)){
          ...
          mysqli_query($dbc, "INSERT INTO users (first_name, last_name, username, email, password,  btc) VALUES('$fname', '$lname', '$uname', ' '$email',  '$password', '$password1', '$btc')"); mysql_select_db(cryptonite);
...
?>            
                  ...
                  <form action="userform.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-sm-12 form-group">
                                <input class="form-control" type="text" name="password1" placeholder="Confirm Password" required="">
                            </div><!-- end col-lg-12 -->
                          
                            <div class="col-lg-12 col-sm-12 form-group">
                                <input class="form-control" type="text" name="btc" placeholder="Bitcoin Wallet Address" required="">
                            </div><!-- end col-lg-12 -->

                            <div class="col-lg-12 col-sm-12 col-xs-12 form-condition">
                                <div class="custom-checkbox">
                                    <input type="checkbox" id="chb1">
                                    <label for="chb1">I agree to Bitcon's <a href="#">Privacy Policy</a></label>
                                </div>
                                <div class="custom-checkbox">
                                    <input type="checkbox" id="chb2">
                                    <label for="chb2">I agree to Bitcon's <a href="#">Terms of Services</a></label>
                                </div>
                            </div><!-- end col-lg-12 -->
...
<section class="footer-area">
    ...
    <div class="container">
        ...
        <div class="copyright-content row">
            <div class="col-lg-6">
                <p class="copy__desc">&copy; 2020 Bitcon. All Rights Reserved. By <a
